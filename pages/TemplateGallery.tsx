          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-gray-900 font-heading">Template Gallery</h1>
                  <p className="text-sm text-gray-600 font-primary">{allTemplates.length} professional templates</p>
                </div>
              </div>
            </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white shadow-lg font-primary"
              />
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <select
              ...
              className="px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white shadow-lg font-primary"
            >
                ...
                >
                  ...
                  <div className="p-6 flex-1">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="text-lg font-semibold text-gray-900 group-hover:text-primary-600 transition-colors font-heading">
                        {template.name}
                      </h3>
