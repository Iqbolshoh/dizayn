...
const AddSectionButton: React.FC<AddSectionButtonProps> = ({
  ...
  return (
    <div className="relative group py-4 font-sans">
      {/* Animated line */}
      ...
      <motion.button
        ...
        className="relative mx-auto flex items-center justify-center w-12 h-12 bg-white border-2 border-dashed border-gray-300 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 hover:border-primary-500 hover:bg-primary-50 shadow-elegant hover:shadow-glow z-10"
      >
        <motion.div
      ...
      <motion.div
        ...
        className="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 px-4 py-3 bg-gray-900 text-white text-sm rounded-xl opacity-0 group-hover:opacity-100 transition-all duration-200 pointer-events-none whitespace-nowrap shadow-elegant-lg font-sans"
      >
