        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-gray-900 font-heading">Help Center</h1>
                <p className="text-gray-600 font-primary">Get help and support</p>
              </div>
            </div>
        ...
        <div className="text-center mb-8">
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-4 border border-gray-300 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent bg-white shadow-lg text-lg font-primary"
            />
          </div>
        </div>
