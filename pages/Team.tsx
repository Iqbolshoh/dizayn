    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 via-white to-accent-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div className="bg-white rounded-2xl shadow-lg border border-gray-200">
              <div className="p-6 border-b border-gray-200">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-semibold text-gray-900 font-heading">Pending Invitations</h2>
                    <p className="text-gray-600 font-primary">Manage sent invitations and their status</p>
                  </div>
                  <button
                    onClick={() => setShowInviteModal(true)}
             ...
             <label className="block text-sm font-medium text-gray-700 mb-2 font-primary">{t('team.inviteModal.role')}</label>
              ...
              {pendingInvites.length === 0 && (
                <div className="p-12 text-center">
                  ...
                  <h3 className="text-lg font-semibold text-gray-900 mb-2 font-heading">No pending invites</h3>
                  <p className="text-gray-600 font-primary">All invitations have been accepted or expired.</p>
                </div>
              )}
            </div>
          </motion.div>
        ...
        {activeTab === 'settings' && (
          ...
          >
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
              <h2 className="text-xl font-semibold text-gray-900 mb-6 font-heading">Team Settings</h2>

              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    <div className="font-medium text-gray-900 font-primary">Allow team members to invite others</div>
                    <div className="text-sm text-gray-600 font-primary">Let admins and editors send invitations</div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    <div className="font-medium text-gray-900 font-primary">Require approval for new members</div>
                    <div className="text-sm text-gray-600 font-primary">Owner must approve all new team members</div>
                  </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl">
                  <div>
                    <div className="font-medium text-gray-900 font-primary">Enable real-time collaboration</div>
                    <div className="text-sm text-gray-600 font-primary">Allow simultaneous editing of projects</div>
                  </div>
                  <button className="w-12 h-6 bg-red-600 rounded-full">
                    <div className="w-5 h-5 bg-white rounded-full translate-x-6 transition-transform" />
                  </button>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-200">
              <h3 className="text-lg font-semibold text-gray-900 mb-4 font-heading">Role Permissions</h3>
