          ...
          {showMobileMenu && (
            ...
            >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-1.5 px-3 py-2.5 bg-orange-600 text-white rounded-lg hover:bg-orange-700 transition-all text-xs font-semibold shadow-glow font-display"
              >
      ...
      <div className="hidden lg:block bg-white/95 border-b border-gray-200 px-4 xl:px-6 py-4 xl:py-5 shadow-elegant-lg backdrop-blur-xl sticky top-0 z-40">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 xl:gap-4">
            ...
            <button
              onClick={handleExport}
              className="flex items-center gap-1.5 xl:gap-2 px-4 xl:px-6 py-2.5 xl:py-3 bg-orange-600 text-white rounded-xl hover:bg-orange-700 transition-all font-semibold shadow-glow font-display text-sm xl:text-base"
            >
              <Code className="w-3 h-3 xl:w-4 xl:h-4" />
              {t('editor.export')}
            </button>
          </div>
        </div>
