          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-secondary-900">Template Gallery</h1>
                  <p className="text-sm text-secondary-600">{allTemplates.length} professional templates</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-secondary-100 text-secondary-700 rounded-xl hover:bg-secondary-200 transition-colors font-medium"
              >
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-4 py-3 border border-secondary-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white shadow-elegant"
              />
            </div>
          </div>
          ...
          <div className="flex gap-3">
            <select
              ...
              className="px-4 py-3 border border-secondary-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 bg-white shadow-elegant"
            >
        ...
        <div className="mt-8">
          {filteredTemplates.length === 0 ? (
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-secondary-900 mb-3">No templates found</h3>
                  ...
                  <div className="p-6 flex-1">
                    ...
                    <div className="flex flex-wrap gap-1 mb-4">
                      {template.tags.slice(0, 3).map((tag) => (
                        <span
                          key={tag}
                          className="px-2 py-1 bg-secondary-100 text-secondary-600 rounded text-xs font-medium"
                        >
                          {tag}
                        </span>
                      ))}
                    ...
                    <div className="flex gap-2">
                      <button
                        onClick={() => handlePreviewTemplate(template)}
                        className="flex-1 px-4 py-2 bg-secondary-100 text-secondary-700 rounded-xl hover:bg-secondary-200 transition-colors font-medium"
                      >
                        Preview
                      </button>
                      <button
                        onClick={() => handleUseTemplate(template)}
                        className="flex-1 px-4 py-2 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-colors font-medium"
                      >
                        Use Template
                      </button>
                    </div>
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-secondary-200">
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h3 className="text-xl font-semibold text-secondary-900">{selectedTemplate.name}</h3>
            ...
            <div className="p-6 max-h-[70vh] overflow-y-auto">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div>
                  <h4 className="font-semibold text-secondary-900 mb-3">Template Details</h4>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between">
                      <span className="text-secondary-600">Category:</span>
                      <span className="font-medium text-secondary-900">{selectedTemplate.category}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-secondary-600">Sections:</span>
                      <span className="font-medium text-secondary-900">{selectedTemplate.sections.length}</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-secondary-600">Downloads:</span>
                      <span className="font-medium text-secondary-900">{selectedTemplate.downloads}</span>
                    </div>
                    <div className="flex justify-between">
                  ...
                  <h4 className="font-semibold text-secondary-900 mb-3 mt-6">Included Sections</h4>
                  <div className="space-y-2">
                    {selectedTemplate.sections.map((sectionId) => (
                      <div key={sectionId} className="flex items-center gap-2 p-2 bg-secondary-50 rounded-lg">
                        ...
                        <span className="text-sm text-secondary-700">{sectionId}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl p-6 border border-primary-200">
                    <h4 className="font-semibold text-secondary-900 mb-3">Ready to get started?</h4>
                    ...
                    <button
                      ...
                      className="w-full px-6 py-3 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-colors font-semibold"
                    >
                      Use This Template
                    </button>
                  </div>
