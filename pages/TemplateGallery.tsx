            ...
            <div className="flex items-center gap-3">
              <div className="hidden md:flex items-center gap-2">
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors ${viewMode === 'grid' ? 'bg-primary-100 text-primary-600' : 'text-secondary-600 hover:bg-secondary-100'
                    }`}
                >
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-colors ${viewMode === 'list' ? 'bg-primary-100 text-primary-600' : 'text-secondary-600 hover:bg-secondary-100'
                    }`}
                >
            ...
            <div className={`grid gap-6 ${viewMode === 'grid'
              ...
              {filteredTemplates.map((template, index) => (
                <motion.div
                  ...
                  className={`bg-white rounded-2xl shadow-soft border border-secondary-200 overflow-hidden hover:shadow-medium transition-all group ${viewMode === 'list' ? 'flex' : ''
                    }`}
                >
                  {/* Template Image */}
